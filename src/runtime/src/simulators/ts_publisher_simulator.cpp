...
int main(int argc, char **argv) {
    ...
    ros::init(argc, argv, "tractive_system_publisher_simulator");
    
    // Create a node handler
    ros::NodeHandle ts_publisher_simulator_node;
    ...
    ros::Publisher ts_pub = ts_publisher_simulator_node.advertise<runtime::TractiveSystem>("ts_status_simulated", 100);
    ...
    */
    ...
    while(ros::ok()) {
        // Create a TractiveSystem object
        runtime::TractiveSystem msg;

        // Data structure to keep the possible states
        uint8_t states[2] = {runtime::TractiveSystem::OFF, runtime::TractiveSystem::ON};
